...
import { Page, Card, Grid, Form, Button, Dropdown, El } from "tabler-react";
...
function FormElements() {
  return (
    <SiteWrapper>
      <Page.Content title="Form elements">
        <Grid.Row>
          <Grid.Col width={12} ignoreCol>
            <Card>
              <Card.Header>
                <El.H3 className="card-title">Form elements</El.H3>
              </Card.Header>
              <Card.Body>
                <Grid.Row>
                  <Grid.Col xl={4} ignoreCol>
                    <ComponentDemo>
                      <Form.Group label="Static">
                        <Form.StaticText>Input value</Form.StaticText>
                      </Form.Group>
                    </ComponentDemo>
                    ...
                    <ComponentDemo>
                      <Form.Group label="Required" isRequired>
                        <Form.Input
                          name="example-required-text-input"
                    ...
                    <ComponentDemo>
                      <Form.Group
                        label={
                          <Form.Label aside="56/100" children="Textarea" />
                        }
                      >
                        <Form.Textarea
                  ...
                  Camelot!"
                    ...
                    <ComponentDemo>
                      <Form.Group label="Select multiple">
                  ...
                  <Form.ColorCheckItem color="teal" />
                    ...
                    <ComponentDemo>
                      <Form.Group label="Input group">
                        ...
                        <Form.InputGroup>
                          <Button.Dropdown value="Action" color="white">
                    ...
                    <ComponentDemo>
                      <Form.Group label="Loader input">
                        <Form.Input
                          ...
                          className={"mb-3"}
                        />
                        <Form.Input spinner placeholder="Loading..." />
                      </Form.Group>
                    </ComponentDemo>

                    <ComponentDemo>
                      <Form.Group label="Seperated inputs">
                        <Grid.Row className="row-sm">
                          <Grid.Col>
                            <Form.Input placeholder="Search for..." />
                          </Grid.Col>
                          <Grid.Col auto ignoreCol>
                            <Button color="white" icon="search" />
                          </Grid.Col>
                        </Grid.Row>
                      </Form.Group>
                    </ComponentDemo>
                          ...
                          >
                            <Form.Help
                              message={
                                <React.Fragment>
                                  <p>
                                    ZIP Code must be US or CDN format. You can
                                    use an extended ZIP+4 code to determine
                                    address more accurately.
                                  </p>
                                  <p className="mb-0">
                                    <a href="#help">
                    ...
                    <ComponentDemo>
                      <Form.Group label="Form control rounded">
                        <Form.Input
                          mb={2}
                          name="example-text-input"
                          placeholder="Text..."
                    ...
                    <ComponentDemo>
                      <Form.Group label="Form control flush">
                        <Form.Input
                          mb={2}
                          name="example-text-input"
                          placeholder="Text..."
